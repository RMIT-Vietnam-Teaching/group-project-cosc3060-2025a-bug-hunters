document.getElementById("registerForm").addEventListener("submit", function (e){
    ...
    ["userFirstName", "userLastName", "userEmail", "userPassword", "confirmPassword", "userRole", "captcha"].forEach(id => setError(id, ""));
    ...
    if (!userPassword) {
      ...
      setError("userPassword", "Password must meet at least 2 of: 8+ characters, upper/lowercase, letters & numbers, special character (!@#?]).");
      valid = false;
    }
